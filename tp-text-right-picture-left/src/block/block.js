/**
 * BLOCK: tp-text-right-picture-left
 *
 ...
 */
registerBlockType( 'cgb/block-tp-text-right-picture-left', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'tp-text-right-picture-left - CGB Block' ), // Block title.
	icon: 'shield', // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
	category: 'common', // Block category — Group blocks together based on common traits E.g. common, formatting, layout widgets, embed.
	keywords: [
		__( 'tp-text-right-picture-left — CGB Block' ),
		__( 'CGB Example' ),
	...
	edit: ( props ) => {
		...
		return (
			<div className={ className }>
				...
				<RichText
					tagName="h1"
					placeholder={ __( 'Add your custom heading', 'tp-text-right-picture-left' ) }
				...
				<RichText
					...
					multiline="p"
					format="string"
					placeholder={ __( 'Add your custom message', 'tp-text-right-picture-left' ) }
